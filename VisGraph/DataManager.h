...
typedef std::set<DataItemEditWidget*> DataEditWidgetSet;
typedef std::map<std::string, DataEditWidgetSet> DMEditWidgetMap;
...
public:
	...
	bool removeDataItemEditWidget(const std::string& name, DataItemEditWidget* widget);

private:
	bool notifyChange(const std::string& name);
	bool updateDisplayValue(const std::string& name);
