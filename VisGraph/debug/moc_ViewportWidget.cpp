...
QT_MOC_LITERAL(1, 15, 10), // "finishInit"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12) // "menuCallback"

    },
    "ViewportWidget\0finishInit\0\0menuCallback"
};
...
void ViewportWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finishInit(); break;
        case 1: _t->menuCallback(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ViewportWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ViewportWidget::finishInit)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ViewportWidget::finishInit()
{
